...
class MypageRecyclerViewAdapter(
    private val tasks: MutableList<SellingResponse> = mutableListOf(),
    private val clickListener: (SellingResponse) -> Unit
) : RecyclerView.Adapter<MypageRecyclerViewAdapter.MyViewHolder>() {

    fun updateTasks(newTasks: List<SellingResponse>) {
        tasks.clear()
    ...
    class MyViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(task: SellingResponse, clickListener: (SellingResponse) -> Unit) {
